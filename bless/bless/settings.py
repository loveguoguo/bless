# Django settings for bless project.
import os
...
MEDIA_ROOT = os.path.join(os.path.dirname(__file__), '../upload_files')
...
STATICFILES_DIRS = (
    ...
    ('uploadfiles', os.path.join(STATIC_ROOT, 'uploadfiles')),
)
...
SECRET_KEY = 'gmbalvqm69(x)1s1fve=f!^2$eix!y8^+)rprfq=-+xym&amp;$7nd'
...
ROOT_URLCONF = 'bless.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bless.wsgi.application'
